...
const tr = {
  ...
  landing: {
    ...
    steps: [
      { title: "API'ni bağla", body: "Claude veya OpenAI anahtarını ekle ve bir model seç. Anahtar yalnızca senin tarayıcında kalır." },
    ...
    features: [
      ...
      { title: "Claude veya OpenAI", body: "Claude (Opus, Sonnet, Haiku) ya da OpenAI (Codex, GPT) modelleriyle çalışır. Anahtar senin tarayıcında kalır." },
    ],
  ...
  settings: {
    ...
    subtitle: "İş akışı üretmek için Claude veya OpenAI hesabını bağla. Kaydettiğin sağlayıcı üretimde kullanılır.",
    provider: "Sağlayıcı",
    providers: {
      anthropic: {
        label: "Claude",
...
const en: Dict = {
  ...
  landing: {
    ...
    steps: [
      { title: "Connect your API", body: "Add a Claude or OpenAI key and pick a model. The key stays in your browser." },
    ...
    features: [
      ...
      { title: "Claude or OpenAI", body: "Works with Claude (Opus, Sonnet, Haiku) or OpenAI (Codex, GPT) models. Your key stays in your browser." },
    ],
  ...
  settings: {
    ...
    subtitle: "Connect your Claude or OpenAI account to generate workflows. The provider you save is used for generating.",
    provider: "Provider",
    providers: {
      anthropic: {
        label: "Claude",
