    ...
    nodes: [
      {
        ...
        typeVersion: 1,
        position: [250, 300],
        parameters: { httpMethod: "POST", path: "incoming-data", responseMode: "lastNode" },
      },
      {
        id: "set-1",
        name: name("parse"),
    ...
    nodes: [
      {
        ...
        typeVersion: 1,
        position: [250, 300],
        parameters: { httpMethod: "POST", path: "contact-form", responseMode: "lastNode" },
      },
      {
        id: "set-1",
        name: name("normalize"),
      ...
      },
      {
        ...
        parameters: {
          ...
          table: { mode: "name", value: "Contacts" },
        },
      },
      {
        id: "gmail-1",
